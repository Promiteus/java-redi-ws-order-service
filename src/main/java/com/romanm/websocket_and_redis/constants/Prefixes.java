...
public class Prefixes {
    ...
    public static final String API_PAGE = "/page/{page}/size/{size}";
    ...
    public static final String API_DIAL_DELETE_BY_USER_PATH = API_DIAL_PATH+API_USER;
    public static final String API_DIAL_DELETE_BY_EXECUTOR_PATH = API_DIAL_PATH+API_EXECUTOR;
